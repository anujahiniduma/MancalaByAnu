package anu.game.bol.model.db;


import anu.game.bol.model.Board;
import anu.game.bol.model.FileCache;
...
public class FileCacheTest {
    ...
    public void testMoveFormat() {
        ...
        assertEquals(testBoard.nextMoves().stream().map(move -> move.getBox()).collect(Collectors.toList()), FileCache.parseNextMoves(EXPECTED_MOVES));
    }
